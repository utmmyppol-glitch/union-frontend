      ...
      <section style={{
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{
            ...
            고객님의 개인정보를 중요시하며, &ldquo;정보통신망 이용촉진 및 정보보호&rdquo;에 관한 법률을 준수하고 있습니다.
          </p>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <div style={{
            ...
            <p style={{ fontSize: 17, lineHeight: 1.85, color: 'var(--ink)', margin: '0 0 16px', fontWeight: 500 }}>
              &lsquo;유니온시스템즈&rsquo;은(는) (이하 &lsquo;회사&rsquo;는) 고객님의 개인정보를 중요시하며,
              &ldquo;정보통신망 이용촉진 및 정보보호&rdquo;에 관한 법률을 준수하고 있습니다.
            </p>
      ...
      <section style={{ padding: '0 clamp(20px,4vw,52px) clamp(64px, 8vw, 100px)' , position: 'relative', overflow: 'hidden'}}>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px 32px' }}>
                <div>
                  ...
                  <p style={{ fontSize: 16, fontWeight: 600, margin: 0 }}>백나래 대리</p>
                </div>
                <div>
                  <p style={{ fontSize: 13, color: 'rgba(255,255,255,.35)', margin: '0 0 2px' }}>전 화</p>
                  <p style={{ fontSize: 16, fontWeight: 600, margin: 0 }}>02-706-8999</p>
                </div>
                <div>
                  <p style={{ fontSize: 13, color: 'rgba(255,255,255,.35)', margin: '0 0 2px' }}>팩 스</p>
                  <p style={{ fontSize: 16, fontWeight: 600, margin: 0 }}>02-706-8990</p>
                </div>
                <div>
                  <p style={{ fontSize: 13, color: 'rgba(255,255,255,.35)', margin: '0 0 2px' }}>이메일</p>
                  <p style={{ fontSize: 16, fontWeight: 600, margin: 0 }}>union@unionsystems.co.kr</p>
                </div>
              </div>
            </div>
          ...
          <PolicySection num="10" title="정책 변경에 따른 공지의무">
            <p>이 개인정보취급방침은 아래에 명시된 날짜에 수정되었으며 법령, 정책 또는 보안기술의 변경에 따라
              내용의 추가, 삭제 및 수정이 있을 시에는 변경되는 개인정보취급방침을 시행하기 최소 7일전에
            ...
            <div style={{
              ...
              <p style={{ margin: 0, fontWeight: 700, fontSize: 15 }}>시행일자 : 2022년 07월 08일</p>
            </div>
          </PolicySection>
