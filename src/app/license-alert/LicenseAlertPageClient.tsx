...
/* ── 기본값 ── */
const DEFAULT_HERO = {
  badge: 'SOFTWARE ASSET MANAGEMENT',
  title: '라이선스, 관리하고 계신가요?',
  subtitle: '보유 중인 SW 라이선스 현황을 알려주시면, 갱신 시기·비용 절감·최적 플랜을 안내드립니다.',
  stat_products_label: '취급 제품',
  stat_reply_num: '당일',
  stat_reply_label: '회신 보장',
  stat_clients_num: '200+',
  stat_clients_label: '기업 고객',
};
...
const DEFAULT_SAM_BOX = {
  label: 'SAM이란?',
  desc: 'Software Asset Management. 기업이 보유한 SW 라이선스의 수량·만료·비용을 체계적으로 관리하는 것을 말합니다. 유니온시스템즈가 라이선스 유통·갱신·자산관리를 대행합니다.',
};

const DEFAULT_FORM = {
  submit_label: '라이선스 관리 상담 신청',
  submitting_label: '전송 중...',
};

const DEFAULT_DONE = {
  title: '상담 신청이 완료되었습니다',
  subtitle_prefix: '담당 컨설턴트가 당일 내',
