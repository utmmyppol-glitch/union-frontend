      ...
      <section style={{
        ...
        <div className="wrap" style={{
          ...
          <a href={`tel:${SITE.tel.replace(/-/g, '')}`} style={{
            ...
            <span style={{ fontSize: 18, color: 'var(--ink2)' }}>평일 10–18시</span>
          </a>
        </div>
      </section>
      ...
      <section style={{
        ...
        <div className="wrap" style={{ position: 'relative', zIndex: 1 }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 36 }}>
            ...
            <p style={{ fontSize: 18, color: 'rgba(255,255,255,.4)', margin: 0 }}>편하신 방법으로 연락해주세요.</p>
          </div>
          ...
          <p style={{
            ...
            수집항목: 이름, 회사명, 연락처, 이메일 · 수집목적: 상담 및 이벤트 안내 · 보유기간: 상담 완료 후 1년
          </p>
        </div>
      </section>
