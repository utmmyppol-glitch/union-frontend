...
export default function EstimatePage() {
  ...
  const recoProducts = areas.length > 0
    ...
    <>
      ...
      >
        ...
        <div style={{ position: 'relative', maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            온라인 견적<span style={{ color: 'var(--accent)' }}>.</span>
          </h1>
          <p
            style={{
      ...
      <section style={{ maxWidth: 1200, margin: '0 auto', padding: 'clamp(48px, 7vw, 80px) clamp(20px, 4vw, 52px) 0' }}>
        ...
        >
          아래는 규모별로 자주 도입하는 대표 구성입니다. 견적 도구로 우리 회사에 맞게 조정할
          수 있습니다.
        </p>
        <div
      ...
      >
        ...
        >
          <div>
            ...
            >
              전화 또는 이메일로 문의하시면 담당 컨설턴트가 직접 안내드립니다.
            </p>
          </div>
