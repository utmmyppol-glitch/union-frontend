...
const CONTENT_KEYS = ['estsoft_hero', 'estsoft_strengths', 'estsoft_stats', 'estsoft_products', 'estsoft_plans', 'estsoft_sections', 'estsoft_cta', 'estsoft_trust', 'estsoft_badge', 'estsoft_ui'];
