...
const DEFAULT_STRENGTHS = [
  { num: '01', en: 'Quality', ko: '설계 품질', desc: 'Autodesk의 검증된 설계 도구로 정밀하고 신뢰할 수 있는 설계 결과물을 만들어 냅니다.', accent: false },
  { num: '02', en: 'Cooperation', ko: '팀 협업', desc: '클라우드 기반 공동 작업 환경으로 설계팀 간 실시간 데이터 공유와 리뷰가 가능합니다.', accent: false },
              ...
              >
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                  ...
                  <h3 style={{
                    ...
                    margin: '0 0 4px',
                  }}><E id={`autodesk_strengths[${i}].en`} editMode={editMode}>{s.en}</E></h3>
                  <p style={{
